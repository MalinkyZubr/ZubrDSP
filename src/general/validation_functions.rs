...
pub fn percent_error<T: Num + Signed + Clone + ToPrimitive + Into<f32>>(observed: T, expected: T) -> f32 {
...
pub fn is_within_bounds<T: Num + Signed + PartialOrd>(term: T, bounds: (T, T), bound_types: (BoundType, BoundType)) -> bool {
